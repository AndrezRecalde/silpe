        ...
        <div>
            <center>
                <img src="{{ public_path('/assets/images/logo/LogoMediano.png') }}" alt="logo" width="200px"
                    height="60px">
                <h6 style="margin-top: 20px;">SOLICITUD DE PASANTÍAS</h6>
            </center>
                ...
                <table style="width: 60%;border-collapse: collapse;margin-top: 25px; margin-bottom: 25px;margin-left: auto; margin-right: auto;">
                    ...
                    <tbody>
                        <tr>
                            <td style="border: 1px solid black;padding-right:10px; padding-left:10px">{{ $pasante->fecha }}</td>
                            <td style="border: 1px solid black;padding-right:10px; padding-left:10px">{{ $pasante->cnsctvo_rta }}</td>
                        </tr>
                    </tbody>
                </table>

            <center>
                <span style="margin-bottom: 25px;">{{ $pasante->nmbre_clnte }}</span><br>
                <h6 style="margin-top: 25px;">ASUNTO</h6>
                <span style="margin-bottom: 25px;">{{ Str::upper($pasante->asunto) }}</span>
            </center>
